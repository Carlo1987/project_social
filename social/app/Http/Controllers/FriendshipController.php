...
class FriendshipController extends Controller
{
  ...
  ////////////////    MOSTRARE LISTA RICHIESTE DI AMICIZIA FATTE(friendships) E RICEVUTE(friend_request)
    ...
    ///////////////  CANCELLARE UNA RICHIESTA DI AMICIZIA IN SOSPESO  ///////////

    public function delete($friend_id){
        Friendship::where('user_id',Auth::user()->id)->where('friend_id',$friend_id)->delete();

        return redirect()->route('users.show', ['user' => $friend_id]);
    }
