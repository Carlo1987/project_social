...
<?php $detail = true; ?>
    ...
    <div class="navbar navbarCarouselDetail mb-4"> 
        <div class="w-50 ps-3 fs-5"> Scorri le immagini: </div>    
            ...
            <div class="content_details carousel-inner">
                ...
                <div class="content_row carousel-item active">
                    ...
                    <div class="content_files">
                       ...
                       <?php $type = 'image'; ?>
                        ...
                        <img src="{{ route('images.show',  ['image' => $image->id]) }}" class="d-block w-100" alt="image:detail" style="border-radius: 10px; max-height:450px;">  
                ...
                <div class="content_row carousel-item">
                    ...
                    <div class="content_files">
                        ...
                        <img src="{{ route('images.show',  ['image' => $image->id]) }}" class="d-block w-100" alt="image_detail" style="border-radius: 10px;  max-height:450px;">
