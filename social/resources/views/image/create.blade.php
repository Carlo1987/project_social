                    ...
                    <form method="POST" action="{{ route('images.store') }}" enctype="multipart/form-data" class="form_{{ Themes::show() }}">
                        ...
                        <div class="mb-3 d-flex flex-row justify-content-center gap-3 align-items-center">
                             ...
                             <div>
                                ...
                                <button type="button" class="btn btn-secondary ms-0 lang" onclick="document.querySelector('#image').click()"  data-section="update" data-article="chose_file">
                                      Scegli File 
                                </button> 
                        ...
                        <div class="w-100 text-center mt-3">
                                <button type="submit" class="btn lang" data-section="update" data-article="button_image">
                                    {{ __('Carica immagine') }}
                                </button>
                        </div>
                    </form>
