...
<div class="dropup-center dropup">
    <button class="btn btn-primary dropdown-toggle position-relative" type="button" data-bs-toggle="dropdown" aria-expanded="false" style="width: 185px;">
       <span class="lang" data-section="profile" data-article="questions">richieste in sospeso: </span>   ({{ Friendships::count() }})
    </button>
...
@else     <!--  se non ci sono richieste di amicia -->
    ...
    <button class="btn btn-primary" type="button" style="width: 185px;">
        <span class="lang" data-section="profile" data-article="questions">richieste in sospeso: </span> (0)
    </button>
