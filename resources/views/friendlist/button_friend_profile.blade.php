...
<div class="btn-group dropdown w-100 position-relative">
    <button type="button" class="btn btn-success dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
        <span class="lang" data-section="profile" data-article="friendship_time">Amici da</span> {{ FormatTime::time($friendlist->created_at) }}
    </button>
    <ul class="dropdown-menu  w-auto position-absolute pt-0 fs-5 z-2 rounded" style="background-color: white; ">

        <a class="dropdown-item link-primary w-100 lang" data-bs-toggle="offcanvas" data-bs-target="#offcanvasChat" aria-controls="offcanvasChat" style="cursor: pointer;" data-section="profile" data-article="chat">
            INIZIA CHAT
        </a>
